"""
Django settings for cvverifier project.
...
SECRET_KEY = 'django-insecure-n&#+2qw)0((b*f41t6luqk#)!-2y4f52ck*=vv)wcs40e(d%(b'
...
WSGI_APPLICATION = 'cvverifier.wsgi.application'
